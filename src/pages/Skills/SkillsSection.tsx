...
const SkillCard: React.FC<SkillCardProps> = ({ title, description, accent = 'light', children }) => {
  const bg = accent === 'lime' ? 'bg-[#B9FF66]' : accent === 'dark' ? 'bg-[#191A23]' : 'bg-[#F3F3F3]';
  const descColor = accent === 'dark' ? 'text-white/60' : 'text-black/60';
  return (
    <div className={`flex flex-col ${bg} p-8 rounded-[45px] border border-[#191A23] h-full`} style={{ boxShadow: '0px 5px 0px #191A23' }}>
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 px-4 lg:px-[100px] mb-[100px]">
        ...
        <SkillCard title="Front-End Development" description="Building engaging and user-friendly web interfaces using modern frameworks and cutting-edge technologies." accent="lime">
        ...
        <SkillCard title="Styling & Design" description="Crafting visually appealing and responsive designs with advanced styling tools and frameworks." accent="dark">
        ...
        <SkillCard title="Programming Languages" description="Proficient in multiple languages for problem-solving, algorithms, and building efficient solutions." accent="light">
        ...
        <SkillCard title="Back-End Development" description="Developing robust server-side logic and APIs to power dynamic and scalable web applications." accent="light">
        ...
        <SkillCard title="Database Management" description="Designing and managing databases to ensure secure and efficient data storage and retrieval." accent="lime">
        ...
        <SkillCard title="Web Animations" description="Creating seamless animations and transitions to enhance user engagement and interactivity." accent="dark">
          <SkillIcon label="Framer Motion" icon="🎞️" />
          <SkillIcon label="GSAP" icon="🦎" />
          <SkillIcon label="Lottie" icon="✨" />
        </SkillCard>

        <SkillCard title="Cloud & Deployment" description="Experienced in deploying and managing applications using modern cloud platforms and DevOps tools." accent="light">
        ...
        <SkillCard title="Core CS Concepts" description="Strong foundation in computer science principles including system design and efficient computing techniques." accent="dark">
        ...
        <SkillCard title="UI/UX & Testing" description="Designing user-centric interfaces and ensuring code quality through rigorous testing and debugging." accent="lime">
        ...
        <SkillCard title="Mobile App Development" description="Creating cross-platform mobile apps with sleek designs and robust functionality using React Native." accent="light">
          <SkillIcon label="React Native" icon="⚛️" />
          <SkillIcon label="Expo" icon="📱" />
        </SkillCard>

        <SkillCard title="Version Control" description="Effectively managing code and collaborating on projects to ensure seamless teamwork and delivery." accent="lime">
          <SkillIcon label="GitHub" icon="🐙" />
          <SkillIcon label="GitLab" icon="🦊" />
        </SkillCard>

        <SkillCard title="Personal Development" description="Committed to continuous learning and personal growth to excel in professional environments." accent="dark">
